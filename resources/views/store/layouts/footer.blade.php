			...
			<div class="row">
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					@foreach($categories as $category)
						<li class="p-b-10">
							<a href="{{ route('product') }}?category={{ $category->id }}" class="stext-107 cl7 hov-cl1 trans-04">
								{{ $category->name }}
							</a>
						</li>
					@endforeach
						...
						<div class="p-l-25 p-r-30 p-lr-0-lg">
							<div class="wrap-slick3 flex-sb flex-w">
								...
								<div class="slick3 gallery-lb">
									<div class="item-slick3" data-thumb="{{ asset('store/images/product-detail-01.avif') }}">
										<div class="wrap-pic-w pos-relative">
											<img src="{{ asset('store/images/product-detail-01.avif') }}" alt="IMG-PRODUCT">

											<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="{{ asset('store/images/product-detail-01.avif') }}">
												<i class="fa fa-expand"></i>
											</a>
										</div>
									</div>

									<div class="item-slick3" data-thumb="{{ asset('store/images/product-detail-02.avif') }}">
										<div class="wrap-pic-w pos-relative">
											<img src="{{ asset('store/images/product-detail-02.avif') }}" alt="IMG-PRODUCT">

											<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="{{ asset('store/images/product-detail-02.avif') }}">
												<i class="fa fa-expand"></i>
											</a>
										</div>
									</div>

									<div class="item-slick3" data-thumb="{{ asset('store/images/product-detail-03.avif') }}">
										<div class="wrap-pic-w pos-relative">
											<img src="{{ asset('store/images/product-detail-03.avif') }}" alt="IMG-PRODUCT">

											<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="{{ asset('store/images/product-detail-03.avif') }}">
												<i class="fa fa-expand"></i>
											</a>
										</div>
									</div>
