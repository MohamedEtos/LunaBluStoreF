...
<?php $__env->startSection('head'); ?>
    <!-- ===== PRELOAD LCP IMAGES ===== -->
    <?php if($setting): ?>
    <link rel="preload" as="image" href="<?php echo e(asset($setting->slider1_image)); ?>" type="image/avif" fetchpriority="high">
    <link rel="preload" as="image" href="<?php echo e(asset($setting->slider2_image)); ?>" type="image/avif" fetchpriority="high">
    <link rel="preload" as="image" href="<?php echo e(asset($setting->slider3_image)); ?>" type="image/avif" fetchpriority="high">
    <?php endif; ?>
	...
	<section class="section-slide">
		<div class="wrap-slick1 rs2-slick1">
			<div class="slick1">
                ...
                <?php for($i = 1; $i <= 3; $i++): ?>
				<div class="item-slick1 bg-overlay1" style="background-image: url('<?php echo e(asset($setting->{'slider'.$i.'_image'})); ?>');" role="img"
  aria-label="<?php echo e($setting->{'slider'.$i.'_title'}); ?>" data-thumb="<?php echo e(asset($setting->{'slider'.$i.'_thumb'})); ?>" data-caption="<?php echo e($setting->{'slider'.$i.'_title'}); ?>">
					<div class="container h-full">
						<div class="flex-col-c-m h-full p-t-100 p-b-60 respon5">
							<div class="layer-slick1 animated visible-false" data-appear="fadeInDown" data-delay="0">
								<span class="ltext-202 txt-center cl0 respon2 alt_<?php echo e($i); ?>">
                                    <?php echo e($setting->{'slider'.$i.'_title'}); ?>
							...
							<div class="layer-slick1 animated visible-false" data-appear="fadeInUp" data-delay="800">
								<h1 class="ltext-104 txt-center cl0 p-t-22 p-b-40 respon1">
									<?php echo e($setting->{'slider'.$i.'_caption'}); ?>

                                </h1>
							</div>

							<div class="layer-slick1 animated visible-false" data-appear="zoomIn" data-delay="1600">
								<a href="<?php echo e($setting->{'slider'.$i.'_link'}); ?>" class="flex-c-m  stext-101 bbc cl0 size-101 bg1 bor1 hov-btn2 p-lr-15 trans-04">
									<?php echo e($setting->{'slider'.$i.'_btn_text'}); ?>
			...
			<div class="row">
				...
				<div class="col-md-6 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						<img src="<?php echo e(asset($setting->{'banner'.$i.'_image'})); ?>" alt="IMG-BANNER" width="570" height="370" loading="lazy">

						<a href="<?php echo e($setting->{'banner'.$i.'_link'}); ?>" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
							<div class="block1-txt-child1 flex-col-l">
								<span class="block1-name ltext-102 trans-04 p-b-8">
									<?php echo e($setting->{'banner'.$i.'_title'}); ?>

								</span>

								<span class="block1-info stext-102 trans-04">
									<?php echo e($setting->{'banner'.$i.'_info'}); ?>
				...
				<div class="col-md-6 col-lg-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="<?php echo e(asset($setting->{'banner'.$i.'_image'})); ?>" alt="IMG-BANNER" width="370" height="240" loading="lazy">
	...
	<section class="bg0 p-t-23 p-b-130 arabic_section">
		<div class="container">
			<div class="p-b-10">
				...
				<?php echo e($setting->home_section_title ?? 'اكتشفي جمال التفاصيل...'); ?>
			...
			<div class="flex-w flex-sb-m p-b-52">
				...
				<div class="dis-none panel-search w-full p-t-10 p-b-15">
					<div class="bor8 dis-flex p-l-15">
                        ...
                        <form method="GET" action="<?php echo e(route('home')); ?>" class="mb-4 w-100">
                            <input
                                type="text"
                                name="search"
			...
			<div class="row  isotope-grid" id="products-wrapper">
                <?php echo $__env->make('store.parts.product_loop', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
			</div>
...
<?php echo $__env->make('store.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Papion\Documents\GitHub\LunaBluStoreF\resources\views/store/index.blade.php ENDPATH**/ ?>