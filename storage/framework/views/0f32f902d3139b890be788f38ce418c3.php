			...
			<div class="header-cart-content flex-w js-pscroll">
				...
				<div class="w-full">
					...
					<div class="header-cart-buttons flex-w w-full">
						...
						<a href="<?php echo e(route('shopingcart')); ?>" class="flex-c-m stext-101 cl0 size-107 bg1 bor2  p-lr-15  m-b-10 cl0 mini_pay  bor1 hov-btn1 trans-04">
							الدفع
						</a>
					</div>
				</div>
...
<?php /**PATH C:\Users\Papion\Documents\GitHub\LunaBluStoreF\resources\views/store/layouts/cart.blade.php ENDPATH**/ ?>