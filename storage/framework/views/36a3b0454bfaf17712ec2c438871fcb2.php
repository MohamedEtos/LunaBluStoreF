	<header class="header-v3" >
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop p-l-45">
					...
					<a href="<?php echo e(url('/')); ?>" class="logo">
						<img src="<?php echo e(asset($setting->mainLogo)); ?>" alt="IMG-LOGO">
					</a>
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="/"><img src="<?php echo e(asset($setting->mainLogo)); ?>" alt="IMG-LOGO"></a>
			</div>
...
<?php /**PATH C:\Users\Papion\Documents\GitHub\LunaBluStoreF\resources\views/store/layouts/navbar.blade.php ENDPATH**/ ?>