		...
		<div class="container">
			<div class="flex-w flex-sb-m p-b-52">
				<div class="flex-w flex-l-m filter-tope-group m-tb-10">
					...
					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".<?php echo e($fabric->name); ?>">
				...
				<div class="dis-none panel-search w-full p-t-10 p-b-15">
					<div class="bor8 dis-flex p-l-15">
                        ...
                        <form method="GET" action="<?php echo e(route('product')); ?>" class="mb-4 w-100" >
                            <input
                                type="text"
                                name="search"
				...
				<div class="dis-none panel-filter w-full p-t-10">
					<div class="wrap-filter flex-w bg6 w-full p-lr-40 p-t-27 p-lr-15-sm">
						<div class="filter-col1 p-r-15 p-b-27">
							...
							<ul>
								<li class="p-b-6">
									<a href="<?php echo e(route('product', array_merge(request()->query(), ['sort' => 'default']))); ?>" class="filter-link stext-106 trans-04 <?php echo e(request('sort') == 'default' || !request('sort') ? 'filter-link-active' : ''); ?>">
										الإفتراضي
									</a>
								</li>

								<li class="p-b-6">
									<a href="<?php echo e(route('product', array_merge(request()->query(), ['sort' => 'popularity']))); ?>" class="filter-link stext-106 trans-04 <?php echo e(request('sort') == 'popularity' ? 'filter-link-active' : ''); ?>">
										الأكثر شهرة
									</a>
								</li>

								<li class="p-b-6">
									<a href="<?php echo e(route('product', array_merge(request()->query(), ['sort' => 'rating']))); ?>" class="filter-link stext-106 trans-04 <?php echo e(request('sort') == 'rating' ? 'filter-link-active' : ''); ?>">
										التقييم
									</a>
								</li>

								<li class="p-b-6">
									<a href="<?php echo e(route('product', array_merge(request()->query(), ['sort' => 'newness']))); ?>" class="filter-link stext-106 trans-04 <?php echo e(request('sort') == 'newness' ? 'filter-link-active' : ''); ?>">
										الأحدث
									</a>
								</li>

								<li class="p-b-6">
									<a href="<?php echo e(route('product', array_merge(request()->query(), ['sort' => 'price_low']))); ?>" class="filter-link stext-106 trans-04 <?php echo e(request('sort') == 'price_low' ? 'filter-link-active' : ''); ?>">
										السعر: من الأقل للأعلى
									</a>
								</li>

								<li class="p-b-6">
									<a href="<?php echo e(route('product', array_merge(request()->query(), ['sort' => 'price_high']))); ?>" class="filter-link stext-106 trans-04 <?php echo e(request('sort') == 'price_high' ? 'filter-link-active' : ''); ?>">
						...
						<div class="filter-col2 p-r-15 p-b-27">
							...
							<ul>
								<li class="p-b-6">
									<a href="<?php echo e(route('product', array_merge(request()->except(['min_price', 'max_price'])))); ?>" class="filter-link stext-106 trans-04 <?php echo e(!request('min_price') && !request('max_price') ? 'filter-link-active' : ''); ?>">
										الكل
									</a>
								</li>

								<li class="p-b-6">
									<a href="<?php echo e(route('product', array_merge(request()->query(), ['min_price' => 0, 'max_price' => 50]))); ?>" class="filter-link stext-106 trans-04 <?php echo e(request('min_price') == 0 && request('max_price') == 50 ? 'filter-link-active' : ''); ?>">
										0.00 ج.م - 50.00 ج.م
									</a>
								</li>

								<li class="p-b-6">
									<a href="<?php echo e(route('product', array_merge(request()->query(), ['min_price' => 50, 'max_price' => 100]))); ?>" class="filter-link stext-106 trans-04 <?php echo e(request('min_price') == 50 && request('max_price') == 100 ? 'filter-link-active' : ''); ?>">
										50.00 ج.م - 100.00 ج.م
									</a>
								</li>

								<li class="p-b-6">
									<a href="<?php echo e(route('product', array_merge(request()->query(), ['min_price' => 100, 'max_price' => 150]))); ?>" class="filter-link stext-106 trans-04 <?php echo e(request('min_price') == 100 && request('max_price') == 150 ? 'filter-link-active' : ''); ?>">
										100.00 ج.م - 150.00 ج.م
									</a>
								</li>

								<li class="p-b-6">
									<a href="<?php echo e(route('product', array_merge(request()->query(), ['min_price' => 150, 'max_price' => 200]))); ?>" class="filter-link stext-106 trans-04 <?php echo e(request('min_price') == 150 && request('max_price') == 200 ? 'filter-link-active' : ''); ?>">
										150.00 ج.م - 200.00 ج.م
									</a>
								</li>

								<li class="p-b-6">
									<a href="<?php echo e(route('product', array_merge(request()->query(), ['min_price' => 200]))); ?>" class="filter-link stext-106 trans-04 <?php echo e(request('min_price') == 200 && !request('max_price') ? 'filter-link-active' : ''); ?>">
										200.00+ ج.م
									</a>
								</li>
							</ul>
...
<?php echo $__env->make('store.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Papion\Documents\GitHub\LunaBluStoreF\resources\views/store/product.blade.php ENDPATH**/ ?>