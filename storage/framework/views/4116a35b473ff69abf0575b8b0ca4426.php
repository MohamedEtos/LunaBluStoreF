...
<style>
    ...
    <meta property="og:description" content="<?php echo e($product->productDetalis); ?>" />
    <meta property="og:image" content="<?php echo e(asset($product->product_img_p->mainImage)); ?>" />
	...
	<section class="sec-product-detail bg0 p-t-65 p-b-60 m-t-40  " >
			...
			<div class="row   ">
					...
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="slick3 gallery-lb">
								<div class="item-slick3" data-thumb="<?php echo e(asset($product->product_img_p->mainImage)); ?>">
									<div class="wrap-pic-w pos-relative">
										<img src="<?php echo e(asset($product->product_img_p->mainImage)); ?>" alt="<?php echo e($product->name); ?>">

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="<?php echo e(asset($product->product_img_p->mainImage)); ?>">
											<i class="fa fa-expand"></i>
										</a>
									</div>
								</div>

								<div class="item-slick3" data-thumb="<?php echo e(asset($product->product_img_p->img2)); ?>">
									<div class="wrap-pic-w pos-relative">
										<img src="<?php echo e(asset($product->product_img_p->img2)); ?>" alt="<?php echo e($product->name); ?>">

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="<?php echo e(asset($product->product_img_p->img2)); ?>">
											<i class="fa fa-expand"></i>
										</a>
									</div>
								</div>

								<div class="item-slick3" data-thumb="<?php echo e(asset($product->product_img_p->img3)); ?>">
									<div class="wrap-pic-w pos-relative">
										<img src="<?php echo e(asset($product->product_img_p->img3)); ?>" alt="<?php echo e($product->name); ?>">

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="<?php echo e(asset($product->product_img_p->img3)); ?>">
											<i class="fa fa-expand"></i>
										</a>
									</div>

								</div>
								<div class="item-slick3" data-thumb="<?php echo e(asset($product->product_img_p->img4)); ?>">
									<div class="wrap-pic-w pos-relative">
										<img src="<?php echo e(asset($product->product_img_p->img4)); ?>" alt="<?php echo e($product->name); ?>">

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="<?php echo e(asset($product->product_img_p->img4)); ?>">
											<i class="fa fa-expand"></i>
										</a>
									</div>
								</div>

                                <?php if($product->product_img_p->img5): ?>
                                <div class="item-slick3" data-thumb="<?php echo e(asset($product->product_img_p->img5)); ?>">
									<div class="wrap-pic-w pos-relative">
										<img src="<?php echo e(asset($product->product_img_p->img5)); ?>" alt="<?php echo e($product->name); ?>">

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="<?php echo e(asset($product->product_img_p->img5)); ?>">
											<i class="fa fa-expand"></i>
										</a>
									</div>
								</div>
                                ...
                                <?php if($product->product_img_p->img6): ?>
                                <div class="item-slick3" data-thumb="<?php echo e(asset($product->product_img_p->img6)); ?>">
									<div class="wrap-pic-w pos-relative">
										<img src="<?php echo e(asset($product->product_img_p->img6)); ?>" alt="<?php echo e($product->name); ?>">

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="<?php echo e(asset($product->product_img_p->img6)); ?>">
											<i class="fa fa-expand"></i>
										</a>
									</div>
								</div>
				...
				<div class="col-md-6 col-lg-5 p-b-30" dir="rtl">
					<div class="p-r-50 p-t-5 p-lr-0-lg h4">
							<?php echo e($product->name); ?> <span style="<?php echo e($product->stock > 0 ? 'color:green' : 'color:red'); ?>">(<?php echo e($product->stock > 0 ? 'متوفر' : 'غير متوفر'); ?>)</span>
                        </h1>
                        ...
                        <div class="flex-w flex-m   p-t-10">
                            ...
                            <span class="stext-102 cl3">
                                (<?php echo e($product->approved_reviews_count); ?> تقيمات)
                            </span>
                        </div>
						...
						<span class="mtext-106  cl2">
							<?php echo e($product->price); ?> ج.م
						</span>

						<p class="stext-102 cl3 p-t-23">
							<?php echo e($product->productDetalis); ?>
						...
						<div class="p-t-10">
                                    ...
                                    <div class="flex-w p-t-4 p-b-10">
                                        <?php if($product->sizes->count() > 0): ?>
                                            <?php $__currentLoopData = $product->sizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="option-btn size-option <?php echo e($size->stock <= 0 ? 'disabled' : ''); ?>" 
                                                     data-value="<?php echo e($size->size); ?>" 
                                        ...
                                        <?php else: ?>
                                            <div class="option-btn active" data-value="<?php echo e($product->width); ?> * <?php echo e($product->height); ?>">
                                                '-'
                                            </div>
                                        <?php endif; ?>
                                        <input type="hidden" name="size" id="selected-size" value="<?php echo e($product->sizes->count() == 0 ? $product->width.' * '.$product->height : ''); ?>">
                                    </div>
								</div>
							</div>
                                ...
                                <div class="size-204 respon6-next">
                                    <div class="flex-w p-t-4">
                                        <?php $__currentLoopData = $product->colors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="color-option <?php echo e($color->stock <= 0 ? 'disabled' : ''); ?>" 
                                                 data-value="<?php echo e($color->color); ?>"
                                                 data-stock="<?php echo e($color->stock); ?>"
							...
							<div class="flex-w  p-b-10">
								<div class="size-204 flex-w flex-m respon6-next">
									...
									<button data-product-id="<?php echo e($product->id); ?>"  class="flex-c-m stext-101 cl0 size-101 bg1 mr-3 bor1  p-lr-15 trans-04 <?php echo e($product->stock > 0 ? 'js-addcart-detail hov-btn1 ': 'bg2 hov-btn50'); ?>">
										اضف  الي السله
									</button>
								</div>
							</div>
                    ...
                    <div class="flex-w h5 flex-m p-l-100 p-t-20 respon7">
						...
						<div class="flex-w flex-m p-l-100 p-t-20 respon7">
							...
							<a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e(urlencode(url()->current())); ?>"   target="_blank"  data-tooltip="facebook" aria-label="Visit our Facebook page" class="fs-35 mr-3 cl3 hov-cl1 trans-04 lh-10 p-lr-5 p-tb-2  tooltip100">
			...
			<div class="bor10 m-t-50 p-t-43 p-b-40">
				...
				<div class="tab01 " dir="rtl">
					...
					<ul class="nav nav-tabs" role="tablist">
						...
						<li class="nav-item p-b-10">
							<a class="nav-link" data-toggle="tab" href="#reviews" role="tab">التقيم (<?php echo e($product->approved_reviews_count); ?>)</a>
						</li>
					</ul>
								...
								<div class="col-sm-10 col-md-8 col-lg-6 m-lr-auto">
									<ul class="p-lr-28 p-lr-15-sm">
										...
										<li class="flex-w flex-t p-b-7">
											...
											<span class="stext-102 cl6 size-206">
												<?php echo e($product->sizes->pluck('name')->implode(', ')); ?>
										...
										<li class="flex-w flex-t p-b-7">
											...
											<span class="stext-102 cl6 size-206">
												<?php echo e($product->fabricType->name); ?>
							...
							<div class="row">
								<div class="col-sm-10 col-md-8 col-lg-6 m-lr-auto">
                                    ...
                                    <div id="reviews-list-container">
                                        <?php $__currentLoopData = $product->reviews->where('is_approved', 1)->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												...
												<div class="flex-w flex-sb-m p-b-17">
                                                    <div class="flex-w flex-m">
                                                        <div class="avatar-initials">
                                                            <?php echo e(mb_strtoupper(mb_substr($review->name, 0, 1))); ?> <?php echo e(mb_strtoupper(mb_substr($review->name, 1, 1))); ?>
										...
										<form class="w-full" id="review-form" action="<?php echo e(route('review.store')); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
											...
											<div class="row p-b-25">
												...
												<div class="col-sm-6 p-b-5">
													...
													<input class="size-111 bor8 stext-102 cl2 p-lr-20" id="name" type="text" name="name" value="<?php echo e(auth()->check() ? auth()->user()->name : ''); ?>" required>
												</div>
		...
		<div class="bg6 flex-c-m flex-w size-302 m-t-73 p-tb-15">
			<span class="stext-107 cl6 p-lr-25">
				الخامه :<?php echo e($product->fabricType->name); ?>
                                    ...
                                    <div class="block2-txt flex-w flex-t p-t-14">
                                        ...
                                        <div class="block2-txt-child2 flex-r p-t-3">
                                            <a href="#" class="btn-addwish-b2 dis-block pos-relative js-addwish-b2">
                                                <img class="icon-heart1 dis-block trans-04" src="<?php echo e(asset('store/images/icons/icon-heart-01.png')); ?>" alt="ICON">
                                                <img class="icon-heart2 dis-block trans-04 ab-t-l" src="<?php echo e(asset('store/images/icons/icon-heart-02.png')); ?>" alt="ICON">
                                            </a>
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('store.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Papion\Documents\GitHub\LunaBluStoreF\resources\views/store/productshow.blade.php ENDPATH**/ ?>