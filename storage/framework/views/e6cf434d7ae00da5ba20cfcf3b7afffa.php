...
<!--===============================================================================================-->
	<script src="<?php echo e(asset('store/vendor/jquery/jquery-3.2.1.min.js')); ?>"></script>
<!--===============================================================================================-->
	
	
<!--===============================================================================================-->
	<script src="<?php echo e(asset('store/vendor/bootstrap/js/popper.js')); ?>"></script>
	
	<script src="<?php echo e(asset('store/vendor/bootstrap/js/bootstrap.min.js')); ?>"></script>
	
<!--===============================================================================================-->
	<script src="<?php echo e(asset('store/vendor/select2/select2.min.js')); ?>"></script>
	<script>
...
<!--===============================================================================================-->
	<script src="<?php echo e(asset('store/vendor/daterangepicker/moment.min.js')); ?>"></script>
	<script src="<?php echo e(asset('store/vendor/daterangepicker/daterangepicker.js')); ?>"></script>
<!--===============================================================================================-->
	<script src="<?php echo e(asset('store/vendor/slick/slick.min.js')); ?>"></script>
	<script src="<?php echo e(asset('store/js/slick-custom.js')); ?>"></script>
<!--===============================================================================================-->
	<script src="<?php echo e(asset('store/vendor/parallax100/parallax100.js')); ?>"></script>
	<script>
        $('.parallax100').parallax100();
	</script>
<!--===============================================================================================-->
	<script src="<?php echo e(asset('store/vendor/MagnificPopup/jquery.magnific-popup.min.js')); ?>"></script>
...
<!--===============================================================================================-->
	...
	<script>
        ...
        <?php if(Session::has('success')): ?>
            swal("نجاح", "<?php echo e(session('success')); ?>", "success");
        <?php endif; ?>

        <?php if(Session::has('error')): ?>
            swal("خطأ", "<?php echo e(session('error')); ?>", "error");
        <?php endif; ?>
	</script>
<!--===============================================================================================-->
	<script src="<?php echo e(asset('store/vendor/perfect-scrollbar/perfect-scrollbar.min.js')); ?>"></script>
...
<!--===============================================================================================-->
	<script src="<?php echo e(asset('store/js/main.js')); ?>"></script>
		...
		(function() {
			...
			function sendActivity() {
				...
				if (navigator.sendBeacon) {
					...
					navigator.sendBeacon('<?php echo e(route("storeVisitorActivity")); ?>', blob);
				} else {
					// Fallback to fetch
					fetch('<?php echo e(route("storeVisitorActivity")); ?>', {
						method: 'POST',
						body: formData,
						keepalive: true
...
<?php /**PATH C:\Users\Papion\Documents\GitHub\LunaBluStoreF\resources\views/store/layouts/scripts.blade.php ENDPATH**/ ?>