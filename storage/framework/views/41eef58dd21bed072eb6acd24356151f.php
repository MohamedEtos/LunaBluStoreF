...
<form class="bg0 p-t-100 mt-5 p-b-85" id="cartPage" method="POST" action="<?php echo e(route('prossesCart')); ?>">
    <?php echo csrf_field(); ?>
	<div class="container">
		<div class="row">
				...
				<div class="m-l-25 m-r--38 m-lr-0-xl">
					<div class="wrap-table-shopping-cart">
						<table class="table-shopping-cart">
							...
							<?php if(!empty($cartData['items']) && count($cartData['items']) > 0): ?>

								<?php $__currentLoopData = $cartData['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $it): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

									<tr class="table_row" data-product-id="<?php echo e($it['key']); ?>">

										<td class="column-1">
											<a class="how-itemcart1 mt-2 hov3 trans-04" href="<?php echo e(route('product.show', $it['slug'])); ?>"
                                                 data-product-id="<?php echo e($it['product_id']); ?>">
                                            <img src="<?php echo e($it['image'] ?: asset('store/images/placeholder.jpg')); ?>" alt="<?php echo e($it['name']); ?>">
                                            <input type="hidden" name="items[<?php echo e($loop->index); ?>][id]" value="<?php echo e($it['product_id']); ?>">
                                            <input type="hidden" name="items[<?php echo e($loop->index); ?>][qty]" value="<?php echo e($it['qty']); ?>" class="cart_qty" data-product-id="<?php echo e($it['key']); ?>">
                                            <input type="hidden" name="items[<?php echo e($loop->index); ?>][size]" value="<?php echo e($it['size'] ?? ''); ?>">
                                            <input type="hidden" name="items[<?php echo e($loop->index); ?>][color]" value="<?php echo e($it['color'] ?? ''); ?>">
                                            </a>
										</td>
										...
										<td class="column-2">
                                            ...
                                            <?php if(!empty($it['size'])): ?>
                                                <br><span class="stext-111 cl6">المقاس: <?php echo e($it['size']); ?></span>
                                            <?php endif; ?>
                                            <?php if(!empty($it['color'])): ?>
                                                <br><span class="stext-111 cl6">اللون: <?php echo e($it['color']); ?></span>
                                            <?php endif; ?>
                                        </td>

										<td class="column-3">ج.م <?php echo e(number_format($it['price'], 2)); ?></td>
										...
										<td class="column-4">
											<div class="wrap-num-product flex-w m-l-auto m-r-0">
												...
												<input
                                                    ...
                                                    type="number"
                                                    min="1"
                                                    value="<?php echo e((int)$it['qty']); ?>"
                                                    data-product-id="<?php echo e($it['key']); ?>"
                                            ...
                                            <?php if(isset($it['stock_available'])): ?>
                                                <small class="stext-111 cl6 d-block p-t-5">
                                                    متبقي في المخزن: <?php echo e((int)$it['stock_available']); ?>
										...
										<td class="column-5 row_total">
                                            ج.م <?php echo e(number_format($it['line_total'], 2)); ?>
					...
					<div class="flex-w flex-sb-m bor15 p-t-18 p-b-15 p-lr-40 p-lr-15-sm">
						<div class="flex-w flex-m m-r-20 m-tb-5">
							...
							<a class="flex-c-m stext-101 cl2 size-118 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer m-tb-5" href="<?php echo e(route('product')); ?>">
								متابعه التسوق
                            </a>
						</div>
					...
					<div class="flex-w flex-t bor12 p-b-13">
                        ...
                        <div class="size-209">
                            <span class="mtext-110 cl2" id="shipping">
                                ج.م <?php echo e(number_format($cartData['shipping_cost'] ?? 0, 2)); ?>
					...
					<div class="flex-w flex-t bor12 p-b-13">
						...
						<div class="size-209">
							<span class="mtext-110 cl2" id="pageSubtotal">
                                ج.م <?php echo e(number_format($cartData['subtotal'] ?? 0, 2)); ?>
							...
							<div class="p-t-4">
								...
								<div class="rs1-select2 rs2-select2 bor8 bg0 m-b-12 m-t-9">
                                        ...
                                        <option value="" selected disabled>اختر المحافظة</option>
                                            ...
                                            <?php $__currentLoopData = $governorate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gov): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>
					...
					<div class="flex-w flex-t p-t-27 p-b-33">
						...
						<div class="size-209 p-t-1">
							<span class="mtext-110 cl2" id="total">
                                ج.م <?php echo e(number_format($cartData['total'] ?? 0, 2)); ?>
                    ...
                    <a href="<?php echo e(route('product')); ?>"  class="d-block text-center p-t-20 stext-101 cl2 hov-cl1">
                         متابعه التسوق
                    </a>
...
$(document).on('change', '#governorate', function () {
  ...
  $.ajax({
    url: "<?php echo e(route('cart.governorate')); ?>",
    type: "PATCH",
...
$(document).on('click', '#btnUpdateCart', function () {
  ...
  inputs.each(function(){
    ...
    <?php if(Session::has('error')): ?>
        <script>toastr.error('<?php echo e(session('error')); ?>', ' error ');</script>
    <?php endif; ?>
...
<?php echo $__env->make('store.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Papion\Documents\GitHub\LunaBluStoreF\resources\views/store/shoping-cart.blade.php ENDPATH**/ ?>