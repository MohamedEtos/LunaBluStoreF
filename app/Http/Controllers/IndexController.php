...
class IndexController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('store.index', [
            ...
            'description' => 'LunaBlu|لونا بلو متجر متخصص في بيع الملابس الطرح العصرية بخامات عالية وجودة مميزة. اكتشفي أحدث الموديلات والألوان المناسبة لكل الإطلالات مع أسعار تنافسية وتجربة تسوق سهلة وآمنة.',
