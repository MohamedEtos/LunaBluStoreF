...
class IndexController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('store.index', [
            ...
            'description' => 'Almonalisa متجر متخصص في بيع الملابس الحريمي العصرية بخامات عالية وجودة مميزة. اكتشفي أحدث الموديلات والألوان المناسبة لكل الإطلالات مع أسعار تنافسية وتجربة تسوق سهلة وآمنة.',
